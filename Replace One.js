// Replace document with specified _id with new document, including the _id field
db.books.replaceOne(
...
// Replace document with specified _id with new document, excluding the _id field (implicitly creating a new ObjectId)
 db.books.replaceOne(
   {_id: ObjectId("65c3ae164d257fbeae952e2d")},
   {
     title: "Deep Dive into React Hooks",
